    ...
    return StreamBuilder<BlynkStatus>(
      ...
      builder: (context, snapshot) {
        ...
        final isDeviceConnected =
            status != BlynkStatus.offline && status != BlynkStatus.loading;
                  ...
                  children: [
                    StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<DropdownMenuItem<String>> patientItems = snapshot
                            .data!
                            .docs
                            .map((doc) {
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      'Enter specific therapy goals, baseline observations, or patient-reported status...',
